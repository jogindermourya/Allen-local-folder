                            ...
                            <a href="#">
                               <img class="img-fluid "  alt=""
                                ...
                                <p class="text-justify p-1 m-0">Orientation Session is our first introduction to parents
                                    ...
                                    session sees the parents ensured that their child has now reached safe hands and
                                    would emerge as a winner in the race of life .</p>
                            </a>
                        </li>
                    </ul>
                    ...
                    <div class="list-unstyled row basepic">
                        ...
                        <div class="blog_single col-12 mt-3">
                            <div class="blog_content note cus_p">
                                <blockquote class="blockquote">
                                    <img src="/assets/img/qoute.png" alt="">
                                    <h6 class="mb-0 f_size_18 l_height30 f_p f_400 d-inline-block">Eager To Set
                                        Benchmarks From First Bench To Last </h6>
                                </blockquote>
                            </div>
                        </div>
    ...
    <div class="container">
        ...
        <div class="blog_single col-12 mt-3">
            <div class="blog_content note cus_p">
                <blockquote class="blockquote">
                    <img src="/assets/img/qoute.png" alt="">
                    <h6 class="mb-0 f_size_18 l_height30 f_p f_400 d-inline-block">Genius Is Mastery Of Doubts - Not
                        Absence Of Doubts. </h6>
                </blockquote>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="blog_single col-12 mt-3">
            <div class="blog_content note cus_p">
                <blockquote class="blockquote">
                    <img src="/assets/img/qoute.png" alt="">
                    <h6 class="mb-0 f_size_18 l_height30 f_p f_400 d-inline-block"> Analyzing And Encouraging</h6>
                </blockquote>
            </div>
        </div>
    </div>
                    ...
                    <div class="list-unstyled row basepic">
                        ...
                        <div class="blog_single col-12 mt-3">
                            <div class="blog_content note cus_p">
                                <blockquote class="blockquote">
                                    <img src="/assets/img/qoute.png" alt="">
                                    <h6 class="mb-0 f_size_18 l_height30 f_p f_400 d-inline-block">Enlightening The Path
                                        To Success</h6>
                                </blockquote>
                            </div>
                        </div>
    ...
    <div class="container">
        ...
        <div class="blog_single">
            <div class="blog_content note cus_p">
                <blockquote class="blockquote">
                    <img src="/assets/img/qoute.png" alt="">
                    <h6 class="mb-0 f_size_18 l_height30 f_p f_400 d-inline-block">Pre-Nurture & Career Foundation</h6>
                ...
                <div class="demo-gallery">
                    ...
                    <div class="blog_single">
                        <div class="blog_content note cus_p">
                            <blockquote class="blockquote">
                                <img src="/assets/img/qoute.png" alt="">
                                <h6 class="mb-0 f_size_18 l_height30 f_p f_400 d-inline-block">Always Staying Ahead As
                                    Evolution Is Our Habit
                                    And Innovation Is Our Passion.</h6>
                            </blockquote>
                        </div>
                    </div>
            ...
            <div class="col-lg-12">
               ...
               <div class="blog_single">
                    <div class="blog_content note cus_p">
                        <blockquote class="blockquote">
                            <img src="/assets/img/qoute.png" alt="">
                            <h6 class="mb-0 f_size_18 l_height30 f_p f_400 d-inline-block">Celebrating Today, Creating Tomorrow</h6>
                        </blockquote>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-12">
               ...
               <div class="blog_single">
                    <div class="blog_content note cus_p">
                        <blockquote class="blockquote">
                            <img src="/assets/img/qoute.png" alt="">
                            <h6 class="mb-0 f_size_18 l_height30 f_p f_400 d-inline-block">A Unique Platform Where Toppers Share And
                                Reveal Their Secrets Of Success.</h6>
                        </blockquote>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-12">
               ...
               <div class="blog_single">
                    <div class="blog_content note cus_p">
                        <blockquote class="blockquote">
                            <img src="/assets/img/qoute.png" alt="">
                            <h6 class="mb-0 f_size_18 l_height30 f_p f_400 d-inline-block">Recognition Of Success Serves
                                As Ignition For Further Success</h6>
                        </blockquote>
                    </div>
                </div>
            </div>
                ...
                <div class="demo-gallery">
                    ...
                    <div class="blog_single">
                        <div class="blog_content note cus_p">
                            <blockquote class="blockquote">
                                <img src="/assets/img/qoute.png" alt="">
                                <h6 class="mb-0 f_size_18 l_height30 f_p f_400 d-inline-block">Creating Positive Environment</h6>
                            </blockquote>
                        </div>
                    </div>
