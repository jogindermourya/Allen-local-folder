    ...
    <div class="container">
        <div class="row payment_testimonial_info mb-lg-5 mb-md-1">
            <div class="col-lg-5 col-md-5 col-sm-12">
                <img src="/assets/img/aboutus/testimonial_img.png" class="img-fluid m-auto pb-2" alt="">
            </div>
                    ...
                    <div class="blog_content note cus_p">
                        <blockquote class="blockquote">
                            <h6 class="mb-0 f_size_18 l_height30 f_p f_400">Dream is not that which you see while
                                sleeping; it is something that does not let you sleep.</h6>
                            <p class="p-0 m-0"> - A.P.J. Abdul Kalam </p>
                        </blockquote>
                    </div>
                </div>
