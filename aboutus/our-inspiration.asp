...
<section class="breadcrumb_area">
    ...
    <div class="container">
        <div class="breadcrumb_content text-center">
            <h1 class="breadcrumb-hed">Our Inspiration</h1>
...
<section class="payment_testimonial_area">
    <div class="container">
        <div class="row payment_testimonial_info mb-lg-3 mb-md-1">
            <div class="col-lg-5 col-md-5 col-sm-12">
                <img src="/assets/img/aboutus/our-inspiration.jpg" class="img-fluid m-auto pb-2 p-4" alt="">
            </div>
