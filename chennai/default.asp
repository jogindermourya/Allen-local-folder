...
<!--#include virtual="/common/newsletter/subscribe_newsletter_chennai.asp"-->
...
<script type="text/javascript">
   ...
   $(document).ready(function () {
      var centerUpdate = chennai_updates;
      centerUpdates(centerUpdate, $);

      var importantUpdate = chennai_importantNotification;
      importantNotifications(importantUpdate, $);

      var resultUpdate = chennai_resultNotification;
