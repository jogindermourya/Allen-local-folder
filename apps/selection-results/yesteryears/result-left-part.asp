    ...
    <div class="result_rightwrp">
        ...
        <ul class="nav" id="accordion88">
            ...
            <ul  id="collapse88" class="collapse toprank_submenu" aria-labelledby="heading88" data-parent="#accordion88">
                <li class="nav-item"><a class="nav-link" href="/result/topranks/default.asp">JEE (Advanced) - IIT-JEE</a></li>
                <li class="nav-item"><a class="nav-link" href="/result/topranks/aiims.asp">AIIMS</a></li>
                <li class="nav-item"><a class="nav-link" href="/result/topranks/aipmt.asp">AIPMT/ NEET(UG)</a></li>
                <li class="nav-item"><a class="nav-link" href="/result/topranks/aieee.asp">JEE (Main) - AIEEE</a></li>
                <li class="nav-item"><a class="nav-link" href="/result/topranks/bhu_main.asp">BHU MAINS</a></li>
            </ul></li>
            <li class="nav-item"><a class="nav-link"
                    href="/result/achievements-pre-nurture-career-foundation.asp">Olympiad, NTSE, KVPY, Scholarship etc</a>
            </li>
        </ul>
</div>
