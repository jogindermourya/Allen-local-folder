            ...
            <li class="entry entry--left">
              <div class="entry__content wow animated fadeIn" data-wow-duration="1s"
                ...
                <div class="row">
                  <div class="col-lg-12">
                    <ul class="list-unstyled score">
                      <li><span>2</span> in Top 20</li>
                      <li><span>11</span> in Top 30</li>
                      <li><span>30</span> in Top 100</li>
                    </ul>
                  </div>
                </div>
            ...
            <li class="entry entry--left">
              <div class="entry__content wow animated fadeIn" data-wow-duration="1s"
                ...
                <div class="row">
                  <div class="col-lg-12">
                    <ul class="list-unstyled score">
                      <li><span>3883 </span> Qualified </li>
                      <li><span>2857</span> CCP</li>
                      <li><span>1026</span> DLP</li>
                    </ul>
                  </div>
                </div>
                <div class="row">
                  <div class="col-lg-12">
                    <ul class="list-unstyled score">
                      ...
                      <li><span>12</span> in Top 50</li>
                      <li><span>25</span> in Top 100</li>
                    </ul>
                  </div>
                </div>
                <div class="row">
            ...
            <li class="entry entry--right">
              <div class="entry__content wow animated fadeIn " data-wow-duration="1s"
                ...
                <div class="row">
                  <div class="col-lg-12">
                    <ul class="list-unstyled score">
                      <li><span>2373  </span> Qualified </li>
                      <li><span>1776</span> CCP</li>
                      <li><span>597</span> DLP</li>
                    </ul>
                  </div>
                </div>
                <div class="row">
                  <div class="col-lg-12">
                    <ul class="list-unstyled score">
                      <li><span>7</span> in Top 50</li>
                      <li><span>14</span> in Top 100</li>
                      <li><span>30</span> in Top 200</li>
                    </ul>
                  </div>
                </div>
                <div class="row">
            ...
            <li class="entry entry--left">
              <div class="entry__content wow animated fadeIn" data-wow-duration="1s"
                ...
                <div class="row">
                  <div class="col-lg-12">
                    <ul class="list-unstyled score">
                      <li><span>1010 </span> Qualified </li>
                      <li><span>901</span> CCP</li>
                      <li><span>109</span> DLP</li>
                    </ul>
                  </div>
                </div>
                <div class="row">
            ...
            <li class="entry entry--right">
              <div class="entry__content wow animated fadeIn" data-wow-duration="1s"
                ...
                <div class="row">
                  <div class="col-lg-12">
                    <ul class="list-unstyled score">
                      <li><span>990 </span> Qualified </li>
                      <li><span>896</span> CCP</li>
                      <li><span>94</span> DLP</li>
                    </ul>
                  </div>
                </div>
                <div class="row">
                  <div class="col-lg-12">
                    <ul class="list-unstyled score">
                      <li><span>37</span> in Top 1000</li>
                    </ul>
                  </div>
                </div>
                <div class="row">
            ...
            <li class="entry entry--left">
              <div class="entry__content wow animated fadeIn" data-wow-duration="1s"
                ...
                <div class="row">
                  <div class="col-lg-12">
                    <ul class="list-unstyled score">
                      <li><span>1008 </span> Qualified </li>
                      <li><span>963</span> CCP</li>
                      <li><span>45</span> DLP</li>
                    </ul>
                  </div>
                </div>
                <div class="row">
            ...
            <li class="entry entry--right">
              <div class="entry__content wow animated fadeIn" data-wow-duration="1s"
                ...
                <div class="row">
                  <div class="col-lg-12">
                    <ul class="list-unstyled score">
                      <li><span>218</span> Qualified </li>
                      <li><span>204</span> CCP</li>
                      <li><span>14</span> DLP</li>
                    </ul>
                  </div>
                </div>
                <div class="row">
                  <div class="col-lg-12">
                    <ul class="list-unstyled score">
                      <li><span>14</span> in Top 1000</li>
                    </ul>
                  </div>
                </div>
                <div class="row">
            ...
            <li class="entry entry--left">
              <div class="entry__content wow animated fadeIn" data-wow-duration="1s"
                ...
                <div class="row">
                  <div class="col-lg-12">
                    <ul class="list-unstyled score">
                      <li><span>276 </span> Qualified </li>
                      <li><span>234</span> CCP</li>
                      <li><span>42</span> DLP</li>
                    </ul>
                  </div>
                </div>
                <div class="row">
                  <div class="col-lg-12">
                    <ul class="list-unstyled score">
                      <li><span>12</span> in Top 1000</li>
                    </ul>
                  </div>
                </div>
                <div class="row">
            ...
            <li class="entry entry--right">
              <div class="entry__content wow animated fadeIn" data-wow-duration="1s"
                ...
                <div class="row">
                  <div class="col-lg-12">
                    <ul class="list-unstyled score">
                      <li><span>135 In Confirm Merit List</span> Qualified </li>
                      <li><span>42 In Preparatory Course</span> CCP</li>
                      <li><span>996 In Extended Merit List</span> DLP</li>
                    </ul>
                  </div>
                </div>
                <div class="row">
