       ...
       <div class="container">
          <div class="row">
             ...
             <div class="col-lg-2 col-sm-3 ">
                <a href="/kota/neet-ug-aiims-coaching.asp" class=" blue_btn btn_hover d-inline-block"><i class="fa fa-angle-left f_size_20 mr-1"></i> Back</a>
             </div>
          </div>
       </div>
    </section>
...
<%End If%>
             ...
             <div class="cover_box" id="scholarship">
                ...
                <ol>
                  ...
                  <li>For scholarship rules : <a href="/kota/2020-21/scholarship-rules.asp" class="color-blue">Click Here</a></li>
                </ol>
