         ...
         <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="row">
               <div class="col-lg-12 mb-lg-4 text-justify">
                  ...
                  Form available at ALLEN Kota Center or apply online at <strong><a href="http://www.allen.ac.in/">http://www.allen.ac.in/</a></strong>. ASATs are conducted on scheduled dates for Admission in the Courses starting on various dates.
				</div>
            </div>
...
<script type="text/javascript">
	...
	$(document).ready(function () {
		var note = kota_asat_note;
		noteLists(note, $);

	});
	
	$(document).ready(function () {
		var paper = kota_sample_papers;
		samplePapers(paper, $);
	});
