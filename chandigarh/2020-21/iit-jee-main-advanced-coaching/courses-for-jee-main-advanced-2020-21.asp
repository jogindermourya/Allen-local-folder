...
<section class="coursebg"> 
      ...
      <div class="row">
        <div class="col-lg-10 col-sm-9 ">
          <ul class="list-unstyled breadcrumb-links m-0">
            ...
            <li><a href="/chandigarh/iit-jee-main-Advanced-coaching.asp">IIT JEE Main Advanced Coaching</a></li>
            <li>IIT-JEE (MAIN + ADVANCED)</li>
          </ul>
        </div>
        <div class="col-lg-2 col-sm-3 "> <a href="/chandigarh/iit-jee-main-advanced-coaching.asp" class=" blue_btn btn_hover d-inline-block"><i class="fa fa-angle-left f_size_20 mr-1"></i> Back</a> </div>
      </div>
    </div>
  </section>
  <style>
  ...
  <section class="cours_content_wrp" ng-app="myApp" ng-controller="chen" ng-cloak >
      ...
      <div class="row mb-3 ">
        <div class="col-lg-12 col-md-12 col-sm-12">
          <div class="cover_box" id="course_details">
            ...
            <h4 class="color-green "><strong>NURTURE (PCM) : <span class="color-darker">Two Year Course for Class XI Students (English Medium Students)</span></strong></h4>
    ...
    -->
                ...
                <tbody ng-repeat="data in iitnurpcm" >
                    <tr>
    ...
    <!--                    <td rowspan="{{data.Courses.length}}"><span>{{ data.centdetail }}</span></td>-->
            ...
            <h4 class="color-green "><strong>NURTURE (PCM + BIO) : <span class="color-darker">Two Year Course for Class XI Students (English Medium Students)</span></strong></h4>
            <div class="table-responsive">            
              <table class="table table-bordered dt-responsive table-hover customtbl cetnble " width="100%">
                <thead>
                    <tr>
    ...
    -->
                ...
                <tbody ng-repeat="data in iitnurpcmbio" >
                    <tr>
                        <td align="center"><span>{{data.Courses[0].phase}}</span></td>
                        <td align="center"><span>{{data.Courses[0].commdate | date : 'dd/MM/yyyy' }}</span></td>
                        <td align="center"><span>{{data.Courses[0].ccode}}</span></td>
    ...
    <!--                    <td rowspan="{{data.Courses.length}}"><span>{{ data.centdetail }}</span></td>-->
            ...
            <h4 class="color-green"><strong>ENTHUSIAST (PCM) : <span class="color-darker">  One Year Course for Class XII Students (English Medium Students)</span></strong></h4>
            <div class="table-responsive">            
                   <table class="table table-bordered dt-responsive table-hover customtbl cetnble " width="100%">
                      <thead>
                          <tr>
                      ...
                      <tbody ng-repeat="data in iitenthpcm" >
                          <tr>
                              <td align="center"><span>{{data.Courses[0].phase}}</span></td>
                              <td align="center"><span>{{data.Courses[0].commdate | date : 'dd/MM/yyyy' }}</span></td>
                              <td align="center"><span>{{data.Courses[0].ccode}}</span></td>
            ...
            <h4 class="color-green"><strong>ENTHUSIAST (PCM + BIO) : <span class="color-darker">  One Year Course for Class XII Students (English Medium Students)</span></strong></h4>
            <div class="table-responsive">            
                   <table class="table table-bordered dt-responsive table-hover customtbl cetnble " width="100%">
                      <thead>
                          <tr>
                      ...
                      <tbody ng-repeat="data in iitenthpcmbio" >
                          <tr>
                              <td align="center"><span>{{data.Courses[0].phase}}</span></td>
                              <td align="center"><span>{{data.Courses[0].commdate | date : 'dd/MM/yyyy' }}</span></td>
                              <td align="center"><span>{{data.Courses[0].ccode}}</span></td>
				...
				<h4 class="color-green"><strong>LEADER (PCM)  : <span class="color-darker"> One Year Course for Class XII Passed / Appeared Students (English Medium Students)</span></strong></h4>
              <div class="table-responsive">
                <table class="table table-bordered dt-responsive table-hover customtbl cetnble " width="100%">
            <thead>
                <tr>
            ...
            <tbody ng-repeat="data in iitleadpcm" >
                <tr>
                    <td align="center"><span>{{data.Courses[0].phase}}</span></td>
                    <td align="center"><span>{{data.Courses[0].commdate | date : 'dd/MM/yyyy' }}</span></td>
                    <td align="center"><span>{{data.Courses[0].ccode}}</span></td>
          ...
          <p>* Keep visiting our website for updated Class Commencement Dates, same will also be informed on student's registered Mobile Numbers at least 7 days in advance.</h5></p>         
          </div>
                        ...
                        <div class="table-responsive">
                          ...
                          <% If date <= bhubfeedate1  Then %>
                            <table    class="table table-bordered table-striped customtbl table-hover myTable" width="100%"  >
                                                ...
                                                <tbody ng-repeat="data in iitfee">
                                                  <tr  >
...
<%End If%>
                        ...
                        <ol>
                            <li>If Total Amount Paid in Lump-sum (one time) : For PCM Courses Rebate of <i class="fa fa-inr"></i> 6000/- and For PCM+Bio Courses Rebate of <i class="fa fa-inr"></i> 8000/- will be given.
                            </li>
                            <li>Total Deductable Amount in Refund* Cases : 1st Refund : <i class="fa fa-inr"></i> 25000/- & Last Refund : <i class="fa fa-inr"></i> 50000/- ( <a href="/chandigarh/2020-21/refund-rules.asp" class="color-blue">Click here for Refund Rules</a> )</li>
                            <li>2nd year fee of Nurture Course will be same as 2020-21 final fee of Enthusiast Course if deposited on or before following last dates;
                              1st installment or lump-sum : <b>20.12.2020,</b> 2nd installment : within 45 days of course commencement. Otherwise fee for 2021-22 will be applicable <br> * Total Amount is inclusive of GST 18% (Present Rate). Fee can be changed, if there is levy/change in taxes by the Central/State Govt.<br>                                ** In case of installment payment option, student have to deposit PDC (Post Dated Cheque) of balance amount at the time of first installment deposit. </li>
                        </ol>
                    </div>
