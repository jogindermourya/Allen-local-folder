         ...
         <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="row">
               <div class="col-lg-12 mb-lg-4 text-justify">
                  <b>About ASAT :</b> ASAT is an Offline (Pen Paper mode) test; consist of multiple choice  questions as per NCERT syllabus. A student has to qualify ALLEN Scholarship Admission Test to take Admission in Yearlong ALLEN Classroom Program at chandigarh Center. To register for ASAT, either fill the Application
                  Form available at ALLEN chandigarh Center or apply online at <strong><a href="http://www.allen.ac.in/">http://www.allen.ac.in/</a></strong>. ASATs are conducted on scheduled dates for Admission in the Courses starting on various dates.
				</div>
            </div>
...
<script type="text/javascript">
	$(document).ready(function () {
		var dates = chandigarh_asat;
		asatDates(dates, $);

	});
	
	$(document).ready(function () {
		var note = chandigarh_asat_note;
		noteLists(note, $);

	});
	
	$(document).ready(function () {
		var paper = chandigarh_sample_papers;
		samplePapers(paper, $);
	});
