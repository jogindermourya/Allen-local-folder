...
<!--#include virtual="/common/newsletter/subscribe_newsletter_chandigarh.asp"-->
...
<script type="text/javascript">
   ...
   $(document).ready(function () {
      var centerUpdate = chandigarh_updates;
      centerUpdates(centerUpdate, $);

      var importantUpdate = chandigarh_importantNotification;
      importantNotifications(importantUpdate, $);

      var resultUpdate = chandigarh_resultNotification;
