      ...
      <div class="row">
         <div class="navbar">
           <ul class="d-flex justify-content-between" id="navscrolling">
            <li class="active"><a href="#course_details"><i class="fa fa-fw fa-home"></i>Course Details</a></li>
            <li><a href="#fee_structure"><i class="fa fa-fw fa-search"></i>Fee Structure</a></li>
            <li><a href="#scholarship"><i class="fa fa-fw fa-search"></i>Scholarship</a></li>
            <li><a href="#ASAT_details"><i class="fa fa-fw fa-search"></i>ASAT Details</a></li>
      ...
      <div class="row">
         <div class="col-lg-12 col-md-12 col-sm-12">
            ...
            <div class="col-md-12">
                   ...
                   <table class="table table-bordered table-striped customtbl table-hover">
                       <tbody>
                           ...
                           <tr>
                               ...
                               <td width="21%"><strong>PHASE-I [A]</strong></td>
                               <td width="23%" valign="top"><strong>PHASE-I</strong></td>
                               <td width="26%"><strong>PHASE-II</strong></td>
                           </tr>
                           <tr>
                           ...
                           <tr>
                               ...
                               <td class="color-red">25/11/2019</td>
                               <td class="color-red">03/04/2020</td>
                               <td class="color-red">16/04/2020</td>
                           </tr>
                           <tr>
                   ...
                   <table class="table table-bordered table-striped customtbl table-hover">
                       <tbody>
                           <tr>
                               ...
                               <td colspan="3"><strong>Direct Admission&nbsp;&nbsp;</strong></td>
                           </tr>
                           <tr>
                               <th colspan="2"><strong>Phases</strong></th>
                               <td width="34%"><strong>PHASE-I</strong></td>
                               <td width="36%"><strong>PHASE-II </strong></td>
                           </tr>
                           <tr>
                           ...
                           <tr>
                               <th colspan="2">Commencement Date</th>
                               <td class="color-red">03/01/2020</td>
                               <td class="color-red">03/04/2020</td>
                           </tr>
                           <tr>
               ...
               <div class="table-responsive">
                   <table width="556" class="table table-bordered table-striped customtbl table-hover">
                       <tbody>
                           <tr>
                               <th colspan="2"><strong>Admission Mode</strong></th>
                               <td width="27%"><strong>
                                 <!--<span style="position:relative; top:4px;">Through ASAT/Direct Admission based on JEE-Main 2019 score.</span><a href="../About-ALLEN-Scholarship-cum-Admission-Test.asp" class="btn-u btn-u-sm rounded btn-u-green  " role="button" style="float: right;">ASAT Details</a>-->Direct Admission</strong></td>
                               <td width="44%"><strong><!--<span style="position:relative; top:4px;">Through ASAT/Direct Admission based on JEE-Main 2019 score.</span><a href="../About-ALLEN-Scholarship-cum-Admission-Test.asp" class="btn-u btn-u-sm rounded btn-u-green  " role="button" style="float: right;">ASAT Details</a>-->ASAT</strong>                                        <a href="../About-ALLEN-Scholarship-Admission-Test.asp" class="blue_btn btn_hover d-inline-block pull-right" role="button">ASAT Details</a></td>
                           ...
                           <tr>
                               <th colspan="2">Commencement Date</th>
                               <td class="color-red">23/04/2020</td>
                               <td class="color-red">11/05/2020</td>
                           </tr>
                           <tr>
                               <th width="13%" rowspan="2">Last Date of Fee Deposition</th>
                               <td width="16%">1st Instl./ Lumpsum </td>
                               <td>21/04/2020</td>
                               <td>09/05/2020</td>
                           </tr>
                           <tr>
                 ...
                 </p><h4 class="headline-brd heading-md"><strong>Classroom Center Code : Kota: 1001</strong></h4>
              </div>
              </div>
         ...
         <div class="cover_box">
            ...
            <div class="table-responsive">
              ...
              <table class="table table-bordered table-striped customtbl table-hover">
                <tbody>
                  <tr>
                    <th align="center" class="text-center" width="15%">&nbsp;</th>
                    <th colspan="3" align="center" class="text-center">Final Fee (Fee valid after 20/01/2020)</th>
                    <th colspan="3" align="center" class="text-center">Fee valid till 20/01/2020</th>
                    <th colspan="3" align="center" class="text-center">Fee valid till 21/12/2019</th>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td class="bg-color-red text-center"><i class="fa fa-inr"></i> 145000/-</td>
                    <td class="color-red text-center"><i class="fa fa-inr"></i> 92000/-</td>
                    <td class="color-red text-center"><i class="fa fa-inr"></i> 53000/-</td>
                    <td class="color-red text-center"><i class="fa fa-inr"></i> 141000/-</td>
                    <td class="color-red text-center"><i class="fa fa-inr"></i> 70500/-</td>
                    <td class="color-red text-center"><i class="fa fa-inr"></i> 70500/-</td>
                    <td class="color-red text-center"><i class="fa fa-inr"></i> 135000/-</td>
                    <td class="color-red text-center"><i class="fa fa-inr"></i> 67500/-</td>
                    <td class="color-red text-center"><i class="fa fa-inr"></i> 67500/-</td>
                  </tr>
                  <tr>
                    <td>Enthusiast</td>
                    <td class="bg-color-red text-center"><i class="fa fa-inr"></i> 147000/-</td>
                    <td class="color-red text-center"><i class="fa fa-inr"></i> 94000/-</td>
                    <td class="color-red text-center"><i class="fa fa-inr"></i> 53000/-</td>
                    <td class="color-red text-center"><i class="fa fa-inr"></i> 143000/-</td>
                    <td class="color-red text-center"><i class="fa fa-inr"></i> 71500/-</td>
                    <td class="color-red text-center"><i class="fa fa-inr"></i> 71500/-</td>
                    <td class="color-red text-center"><i class="fa fa-inr"></i> 137000/-</td>
                    <td class="color-red text-center"><i class="fa fa-inr"></i> 68500/-</td>
                    <td class="color-red text-center"><i class="fa fa-inr"></i> 68500/-</td>
                  </tr>
                  <tr>
                    <td>Leader</td>
                    <td class="bg-color-red text-center"><i class="fa fa-inr"></i> 150000/-</td>
                    <td class="color-red text-center"><i class="fa fa-inr"></i> 97000/-</td>
                    <td class="color-red text-center"><i class="fa fa-inr"></i> 53000/-</td>
              ...
              <table class="table table-bordered table-striped customtbl table-hover">
                <tbody>
                  <tr>
                    <th align="center" class="text-center" width="17%">&nbsp;</th>
                    <th colspan="3" align="center" class="text-center">Final Fee (Fee valid after 31/01/2020)</th>
                    <th colspan="3" align="center" class="text-center">Fee valid till 31/01/2020</th>
                  </tr>
                  <tr>
                    <th align="center" class="text-center">Course Name</th>
                    <th width="11%" align="center" class="text-center">Total Amount*</th>
                    <th width="13%" align="center" class="text-center">1st Installment</th>
                    <th width="16%" align="center" class="text-center">2nd Installment**</th>
                    <th width="14%" align="center" class="text-center">Total Amount*</th>
                    <th width="13%" align="center" class="text-center">1st Installment</th>
                    <th width="16%" align="center" class="text-center">2nd Installment**</th>
                  </tr>
                  <tr>
              ...
              <table class="table table-bordered table-striped customtbl table-hover">
                <tbody>
                  <tr>
                    <th width="24%" align="center" class="text-center">Course Name</th>
                    <th width="18%" align="center" class="text-center">Total Amount*</th>
                    <th width="27%" align="center" class="text-center">1st Installment</th>
                    <th width="31%" align="center" class="text-center">2nd Installment**</th>
                  </tr>
                  <tr>
                    <td>Nurture (1st Year Fee)</td>
                    <td class="bg-color-red text-center"><i class="fa fa-inr"></i> 145000/-</td>
            ...
            <ol>
              ...
              <li>Total Deductable Amount in Refund* Cases : First Refund : <i class="fa fa-inr"></i> 20000/- &amp; Last Refund : <i class="fa fa-inr"></i> 40000/- ( <a href="../refund-rules.asp" class="color-blue">Click here for Refund Rules</a> )</li>
              <li>2nd year fee of Nurture Course will be same as 2020-21 final fee of Enthusiast Course if deposited on or before following last dates;<br>
                1st installment or lump-sum : <strong>20.12.2020</strong>, 2nd installment : within 45 days
                of course commencement. Otherwise fee for 2021-22 will be applicable.<br>
                ...
                ** In case of installment payment option, student have to deposit PDC (Post Dated Cheque) of balance amount at the time of first installment deposit.</li>
            </ol>
         ...
         <div class="cover_box">
            ...
            <table class="table table-bordered table-striped customtbl table-hover">
              <tbody>
                ...
                <tr>
                  <td>For Ex-ALLEN Students of Yearlong CCP, taking admission in Leader<br>
                    (Based on Performance of ENTHUSIAST COURSE)</td>
                  <td>TS09</td>
                  <td>10%-90%</td>
                </tr>
                <tr>
                  <td>Overall Top 20 students of ALLEN NURTURE Course<br>
                ...
                <tr>
                  <td>For HBCSE Olympiad OCSC Stage Physics/Chemistry/Biology/<br>
                ...
                <tr>
                  <td>Any two or more siblings (Real Brother / Sister )<br>
            ...
            <p style="text-align:center;"><strong>A student is eligible for only one scholarship at a time, No two criteria can be clubbed to avail deduction in fee at ALLEN.</strong><strong></strong></p>
            <p>&nbsp;</p>
         </div>
