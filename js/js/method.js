...
function allenslider(images, $) {
	for (var i = 0; i < images.length; i++) {
		$('<div class="carousel-item">' + images[i] + '</div>').appendTo('#carouselExampleSlidesOnly .carousel-inner');
		$('<li data-target="#carouselExampleSlidesOnly" data-slide-to="' + i + '"></li>').appendTo('.carousel-indicators');
	}
...
Latest  = [
	...
	'<img src="image/image-2.jpg" alt="NTSE STAGE-I 2019 Karnataka">',    
...
All = [
	...
	'<img src="image/image-1.jpg" alt="NTSE STAGE-I 2019 Karnataka">',    
...
MAIN = [
	...
	'<img src="image/image-3.jpg" alt="NTSE STAGE-I 2019 Karnataka">',    
