				...
				<div class="col-lg-12">
					...
					<div class="row centersbox_wrp">
						<div class="col-lg-5 m-auto">
							<div class="box-asws">
								<img class="img-fluid " src="/assets/img/contactus/rawatbhata/rawatbhata.jpg" alt="">
								<div class="cont_details text-lg-left">
									...
									<ul class="list-unstyled">
										...
										<li>
											<a href="mailto:prenurture@allen.ac.in"><i
													class="fa fa-envelope"></i>prenurture@allen.ac.in</a></li>
										<li><a href="tel:91-744-2752600"><i class="fa  fa-phone "></i>
