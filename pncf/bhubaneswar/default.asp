...
<script type="text/javascript">
	...
	$(document).ready(function () {
		var centerUpdate = bhubaneswar_pncf_updates;
		centerUpdates(centerUpdate, $);

		var importantUpdate = bhubaneswar_pncf_importantNotification;
		importantNotifications(importantUpdate, $);

		var resultUpdate = bhubaneswar_pncf_resultNotification;
