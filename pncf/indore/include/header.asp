           ...
           <!-- Top Menu Section -->
                                    ...
                                    <ul class="header_contact_info list-unstyled ">
										...
										<li class="dropdown" >
											<a href="/" class="dropdown-toggle " type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-picture-o"></i>  Gallery </a>
											 <ul class="dropdown-menu top-submenu" aria-labelledby="dropdownMenuButton">
												<li><a class="dropdown-item" href="https://www.allen.ac.in/imagegallery/gs/embed.aspx?u=indore">Photo Gallery</a></li>
            ...
            <nav class="navbar navbar-expand-lg menu_one header-decor">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="/pncf/indore/"><img src="/assets/img/pncf_site_logo/pncf_indore_logo.jpg" class="img-fluid" alt="logo"></a>

                    <div class="collapse navbar-collapse justify-content-between" id="navbarSupportedContent">
                        <ul class="navbar-nav menu w_menu ml-auto">
                      
                            <li class="nav-item">
                                <a class="nav-link" href="/pncf/indore/pre-nurture-and-career-foundation-coaching.asp"> Course</a>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="dropdown submenu nav-item">
                                ...
                                <ul role="menu" class=" dropdown-menu">
                                    <li class="nav-item"><a class="nav-link" href="/pncf/indore/2020-21/how-to-apply.asp">How to Apply for APPLICATION FORM</a></li>
                                    <li class="nav-item"><a class="nav-link" href="https://www.allen.ac.in/appsmvc2021/appforms/Login">Apply Online</a></li>
<!--                                    <li class="nav-item"><a class="nav-link" href="/pncf/indore/2020-21/about-allen-scholarship-admission-test.asp">ALLEN Scholarship Admission Test (ASAT)</a></li>-->
                                    <li class="nav-item"><a class="nav-link" href="/pncf/indore/2020-21/fee-deposition-modes.asp">Fee Deposition Modes</a></li>
                                    <li class="nav-item"><a class="nav-link"  href="/pncf/indore/2020-21/scholarship-rules.asp">Scholarship Rules</a></li>
                                    <li class="nav-item"><a class="nav-link" href="/pncf/indore/2020-21/refund-rules.asp"> Refund Rules</a></li>
                                    <!-- <li class="nav-item"><a class="nav-link" href="/pncf/indore/2020-21/allen-kohinoor-hostel.asp">Kohinoor  Hostel Scheme (ACES)</a></li> -->
                                </ul>
                            </li>
                            <li class="dropdown submenu nav-item">
