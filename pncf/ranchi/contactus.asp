				...
				<div class="col-lg-12">
					...
					<div class="row centersbox_wrp">
						<div class="col-lg-5 m-auto">
							<div class="box-asws">
								<img class="img-fluid " src="/assets/img/contactus/ranchi/ranchi.jpg" alt="">
								<div class="cont_details text-lg-left">
									<h5>"HARMU ROAD CENTER" (H.O.)</h5>
									<ul class="list-unstyled">
										<li><a href="#"><i class="fa fa-home"></i></a>
											205, 2nd Floor, Mangal Murti Heights, Beside Vishal Mega Mart,
Harmu Road, Ranchi.
										</li>
										<li>
											<a href="mailto:ranchi@allen.ac.in"><i
													class="fa fa-envelope"></i>ranchi@allen.ac.in</a></li>
										<li><a href="tel:+91-0651-2284228, 9523590990, 7677111005, 7677111006"><i class="fa  fa-phone "></i>
												Ph: <span>+91-0651-2284228, 9523590990, 7677111005, 7677111006</span></a>
										</li>
										
										<li class="text-lg-center">
										<a href="#" onclick="LoadMap_onclick(0,1)" role="button"  orilat="23.349631" orilan="85.335629" deslat="23.375644" deslan="85.314057" placequery="ALLEN Career Institute" > </a>	
