...
<!-- <script type="text/javascript">
	$(document).ready(function () {
		var update = all_updates.concat(Latest_update, pncf_update, ahmedabad_pncf_update_notification);	
		updateLists(update, $);
		
		var results = all_results.concat(Latest_result, pncf_result, ahmedabad_pncf_result_notification);	
		resultsLists(results, $);
		
		var events = all_events.concat(Latest_events, pncf_events, ahmedabad_pncf_events_notification);	
		eventsLists(events, $);
	});
</script> -->
...
<script type="text/javascript">
	...
	$(document).ready(function () {
		var centerUpdate = ahmedabad_pncf_updates;
		centerUpdates(centerUpdate, $);

		var importantUpdate = ahmedabad_pncf_importantNotification;
		importantNotifications(importantUpdate, $);

		var resultUpdate = ahmedabad_pncf_resultNotification;
