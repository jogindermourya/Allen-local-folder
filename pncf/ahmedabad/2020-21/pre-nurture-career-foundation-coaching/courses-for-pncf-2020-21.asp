            ...
            <div class="row">
                <div class="col-lg-10 col-sm-9 ">
                    <ul class="list-unstyled breadcrumb-links m-0">
                        ...
                        <li><a href="/pncf/bengaluru/pre-nurture-and-career-foundation-coaching.asp">Pre-Nurture And Career Foundation Coaching</a></li>
                        <li>Courses for PNCF 2020-21</li>
                    </ul>
                </div>
                <div class="col-lg-2 col-sm-3 ">
                    <a href="/pncf/bengaluru/pre-nurture-and-career-foundation-coaching.asp" class=" blue_btn btn_hover d-inline-block"><i
    ...
    <section class="cours_content_wrp" ng-app="myApp" ng-controller="adi" ng-cloak>
        <div class="container">
          ...
          <div class="cover_box" id="course_details">
			...
			<div class="table-responsive">
				<table class="table table-bordered table-striped coursetbl">
					<tbody>
						<tr>
							<th width="18%">Admission Mode</th>
							<td>ASAT / DIRECT ADMISSION</td>
							<td width="13%"><a href="/pncf/bengaluru/2020-21/about-allen-scholarship-admission-test.asp"
						...
						<tr>
							<th>Class Venue Phase I & II :</th>
							<td colspan="2" valign="middle">  JAYANAGAR (H.O) : 6001, JAYANAGAR (2) : 6001, KORAMANGALA : 6002, HSR LAYOUT : 6003, BASAVESHWARA : 6004, BANASWADI : 6005, BANNERGHATTA : 6006, HEBBAL : 6007, MARATHAHALLI : 6008, SARJAPUR : 6009, JALAHALLI : 6020, WHITEFIELD : 6021, INDIRANAGAR : 6022 </td>
						</tr>
						<tr>
							<th>Class Venue Phase III : </th>
							<td colspan="2" valign="middle">  JAYANAGAR (H.O) : 6001, JAYANAGAR (2) : 6001, KORAMANGALA : 6002, HSR LAYOUT : 6003, BASAVESHWARA : 6004, BANASWADI : 6005, BANNERGHATTA : 6006, HEBBAL : 6007, MARATHAHALLI : 6008, JALAHALLI : 6020, WHITEFIELD : 6021, INDIRANAGAR : 6022</td>
						</tr>
					</tbody>
				</table>
			</div>
		  ...
		  <div ng-repeat="data in bhubcent" ><h5>CLASSROOM CENTERS : <br><br> {{data.centdetail}}</h5></div> 
            ...
            <p class="m-0">Separate Curriculum for CBSE & ICSE in 6001 to 6009 & 6020 to 6022 ALLEN Bengaluru Campuses.</p>
            <p class="m-0 mb-2"> ICSE Curriculum in selected campus only.</p>
			<b><p>* Keep visiting our website for updated Class Commencement Dates, same will also be informed on student's registered Mobile Numbers at least 7 days in advance.</p></b>
          </div>
		...
		<%Else%>
					...
					<table class="table-bordered dt-responsive table-hover customtbl cetnble " width="100%">
                        ...
                        <ol>
                            <li>Total Deductable Amount in Refund* Cases : For 1st Refund : <i class="fa fa-inr"></i> 8000/- & For Last Refund : <i class="fa fa-inr"></i> 16000/-
                            </li>
			...
			<div class="cover_box" id="scholarship">
				...
				<div class="listingwrp">
					<p>1. Scholarship is in the form of Concession in Total Fee (#), student has to claim this by applying in prescribed Scholarship Application Form for Academic Session 2020-21 after admission.</p>
					<p>2. For scholarship rules : <a href="/pncf/bengaluru/2020-21/scholarship-rules.asp">Click Here</a></p> 
					</p>
