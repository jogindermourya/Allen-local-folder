...
<script type="text/javascript">
	...
	$(document).ready(function () {
		var refund = bhilwara_pncf_refundProcess;
		refundProcess(refund, $);

		var sprefund = bhilwara_pncf_specialRefund;
		specialRefund(sprefund, $);

		var important = bhilwara_pncf_importantPoints;
		importantPoints(important, $);

		var rules = bhilwara_pncf_refundRules;
		refundRules(rules, $);

		var service = bhilwara_pncf_changes;
		changes(service, $);
	});
