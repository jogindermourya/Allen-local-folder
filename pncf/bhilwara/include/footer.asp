						...
						<div class="col-lg-2 col-md-6">
							<div class="f_widget about-widget">
								...
								<ul class="list-unstyled f_list">
									<li class="d-none"><a href="/bhilwara/jee-main-coaching.asp">JEE (Main) </a></li>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					...
					<!--#include virtual="/pncf/common/our-apps.asp"-->
				</div>
			</div>
		</div>
	</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					...
					<!--#include virtual="/pncf/common/center-names.asp"-->
				</div>
			</div>
		</div>
	</div>
...
<script src="/assets/js/metatags/metatags-pncf-bhilwara.js"></script>
...
<script src="/pncf/assets/js/schollership-pncf.js"></script>
<script src="/pncf/assets/js/refund-rules-pncf.js"></script>

<script>
   var center = "pncf_bhilwara";
</script>
