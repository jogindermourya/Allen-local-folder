            ...
            <div class="row">
                <div class="col-lg-10 col-sm-9 ">
                    <ul class="list-unstyled breadcrumb-links m-0">
                        ...
                        <li><a href="/pncf/mysuru/pre-nurture-and-career-foundation-coaching.asp">Pre-Nurture And Career Foundation Coaching</a></li>
                        <li>Courses for PNCF 2020-21</li>
                    </ul>
                </div>
                <div class="col-lg-2 col-sm-3 ">
                    <a href="/pncf/mysuru/pre-nurture-and-career-foundation-coaching.asp" class=" blue_btn btn_hover d-inline-block"><i
				...
				<table class="table table-bordered table-striped coursetbl">
					<tbody>
						<tr>
							...
							<td width="13%"><a href="/pncf/mysuru/2020-21/about-allen-scholarship-admission-test.asp"
		...
		<%Else%>
					...
					<table class="table-bordered dt-responsive table-hover customtbl cetnble " width="100%">
                        ...
                        <ol>
                            ...
                            <li>Total Deductable Amount in Refund Cases : First Refund : <i class="fa fa-inr"></i> 10000/- & Last Refund : <i class="fa fa-inr"></i> 20000/- ( <a href="/mysuru/2020-21/refund-rules.asp" class="color-blue">Click here for Refund Rules</a> )</li>
			...
			<div class="cover_box" id="scholarship">
				...
				<div class="listingwrp">
					...
					<p>2. For scholarship rules : <a href="/pncf/mysuru/2020-21/scholarship-rules.asp">Click Here</a></p> 
					</p>
