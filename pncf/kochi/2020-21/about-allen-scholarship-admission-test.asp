         ...
         <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="row">
               <div class="col-lg-12 mb-lg-4 text-justify">
                  ...
                  questions as per NCERT syllabus. A student has to qualify ALLEN Scholarship Admission Test to take Admission in Yearlong ALLEN Classroom Program at kochi Center. To register for ASAT, either fill the
                  Application Form available at ALLEN kochi Center or apply online at <strong><a href="http://www.allen.ac.in/">http://www.allen.ac.in/</a></strong>. ASATs are
...
<script type="text/javascript">
	$(document).ready(function () {
		var dates = pncf_kochi_asat;
		asatDates(dates, $);
	});
	
	$(document).ready(function () {
		var note = pncf_kochi_asat_note;
		noteLists(note, $);
	});
