  ...
  <section class="bricurm">
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-2 col-sm-3 "> <a href="/bhubaneswar/iit-jee-main-advanced-coaching.asp" class=" blue_btn btn_hover d-inline-block"><i class="fa fa-angle-left f_size_20 mr-1"></i> Back</a> </div>
      </div>
    </div>
  </section>
  <style>
...
<!--                    <td rowspan="{{data.Courses.length}}"><span>{{ data.centdetail }}</span></td>-->
            ...
            <tbody ng-repeat="data in iitnew" >
                <tr>
                    <td align="center"><span>{{data.Courses[0].phase}}</span></td>
                    <td align="center"><span>{{data.Courses[0].commdate | date : 'dd/MM/yyyy' }}</span></td>
                    <td align="center"><span>{{data.Courses[0].ccode}}</span></td>
