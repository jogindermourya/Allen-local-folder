       ...
       <div class="container">
          ...
          <div class="cover_box" id="course_details">
            ...
            <tbody ng-repeat="data in mednur" >
			  ...
			  <h4 class="color-green"><strong>NURTURE : <span class="color-darker"> Two Year Course for Class XI Students (CHSE/ODISHA English Medium)</span></strong></h4>
            <div class="table-responsive">
              <table class="table table-bordered dt-responsive table-hover customtbl cetnble " width="100%">
            <thead>
                <tr>
            ...
            <tbody ng-repeat="data in mednurchse" >
                <tr>
                    <td align="center"><span>{{data.Courses[0].phase}}</span></td>
                    <td align="center"><span>{{data.Courses[0].commdate | date : 'dd/MM/yyyy' }}</span></td>
                    <td align="center"><span>{{data.Courses[0].ccode}}</span></td>
            ...
            <tbody ng-repeat="data in medlead" >
			  ...
			  <h4 class="color-green"><strong>LEADER : <span class="color-darker"> One Year Course for Class XII Passed / Appeared Students (CHSE/ODISHA English Medium)</span></strong></h4>
            <div class="table-responsive">
              <table class="table table-bordered dt-responsive table-hover customtbl cetnble " width="100%">
            <thead>
                <tr>
            ...
            <tbody ng-repeat="data in medleadchse" >
                <tr>
                    <td align="center"><span>{{data.Courses[0].phase}}</span></td>
                    <td align="center"><span>{{data.Courses[0].commdate | date : 'dd/MM/yyyy' }}</span></td>
                    <td align="center"><span>{{data.Courses[0].ccode}}</span></td>
...
<!--                           <div id="fee_structure"></div> -->
              <!-- <div ng-repeat="data in bhubcent" >CLASSROOM CENTERS : <br> {{data.centdetail}}</div>             -->
          </div>
          </div>
        </div>
