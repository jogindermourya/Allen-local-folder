<div class="modal fade" id="SELECT_CENTER" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header position-relative">
		<h5 class="modal-title" id="exampleModalLongTitle">Select Your Center</h5>
		<a href="/" class="gateway-link">Back to Gateway</a>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body gateway_notification popup-slect-home sec_pad p-3">
        <div class="row">
			<div class="col-lg-12">
            <form method="post" class="row">
               <div class="col-md-12 mb-4">
                  <div class="input-group phoneinput suscrb">
                     <input type="text" name="search" class="form-control" id="searchbar" onkeyup="search_animal()"
                        placeholder="Search Your Center">
                     <i class="fa fa-search green_btn"></i>
                  </div>
               </div>
            </form>
			<div class="mCustomScrollbar row_ht" data-mcs-theme="dark">
            <div class="row center-row">
               <div class="col-lg-3 col-md-4 col-sm-6 col-6 centers">
                  <a href="/home.asp" class="center_item d-flex justify-content-center align-items-center">
                     <h6>bhubaneswar</h6>
                  </a>
               </div>
               <div class="col-lg-3 col-md-4 col-sm-6 col-6 centers">
                  <a href="/ahmedabad" class="center_item d-flex justify-content-center align-items-center">
                     <h6>Ahmedabad & Gandhinagar</h6>
                  </a>
               </div>
               <div class="col-lg-3 col-md-4 col-sm-6 col-6 centers">
                  <a href="/bengaluru" class="center_item d-flex justify-content-center align-items-center">
                     <h6>Bengaluru</h6>
                  </a>
               </div>
               <div class="col-lg-3 col-md-4 col-sm-6 col-6 centers">
                  <a href="/bhilwara" class="center_item d-flex justify-content-center align-items-center">
                     <h6>Bhilwara</h6>
                  </a>
               </div>
               <div class="col-lg-3 col-md-4 col-sm-6 col-6 centers">
                  <a href="/bhubaneswar" class="center_item d-flex justify-content-center align-items-center">
                     <h6>Bhubaneswar</h6>
                  </a>
               </div>
               <div class="col-lg-3 col-md-4 col-sm-6 col-6 centers">
               ...
               <div class="col-lg-3 col-md-4 col-sm-6 col-6 centers">
                  <a href="#" target="_blank" class="center_item d-flex justify-content-center align-items-center">
                     <h6>Jaipur</h6>
                  </a>
               </div>
               <div class="col-lg-3 col-md-4 col-sm-6 col-6 centers">
			...
			<div class="modal-body sessionwrpr">
				<div class="row">
					...
					<div class="col-xs-6 col-md-4">
						...
						<ul class="list-unstyled">
							<li> <a
									href="https://www.allen.ac.in/pncf/bhubaneswar/2019-20/pre-nurture-career-foundation-coaching/pncf-teaching-methodology-2019-20.asp">Teaching
									Methodology</a></li>
							<li> <a
									href="https://www.allen.ac.in/pncf/bhubaneswar/2019-20/pre-nurture-career-foundation-coaching/courses-for-pncf-2019-20.asp">Courses</a>
							</li>
						</ul>
					</div>
				</div>
...
<div class="modal fade" id="notificationbanner" tabindex="-1" role="dialog" aria-hidden="true">
	<div class="modal-dialog pop8" role="document">
		<div class="modal-content">
			...
			<div class="modal-body p0">
				<a href="#" target="_blank"><img src="/assets/img/popup/admission-open-session-2020.jpg"
	...
	<div class="footer_top_two">
					...
					<div class="row">
						<div class="col-lg-2 col-md-6">
							<div class="f_widget about-widget">
								<h3 class="f-title f_600 t_color2 f_size_16 mb_15">Classroom Courses</h3>
								<ul class="list-unstyled f_list">
									<li><a href="/bhubaneswar/iit-jee-main-advanced-coaching.asp">JEE (Advanced)</a></li>
									<li><a href="/bhubaneswar/neet-ug-aiims-coaching.asp">NEET-UG</a></li>
									<li><a href="/pncf/bhubaneswar/">PNCF (Class 6<sup>th</sup> to 10<sup>th</sup>)</a></li>
						...
						<div class="col-lg-2 col-md-6 ">
							<div class="f_widget about-widget">
								<h3 class="f-title f_600 t_color2 f_size_16 mb_15">Quick Links</h3>
								<ul class="list-unstyled f_list">
									...
									<li><a href="">Gallery</a>
										<ul class="subfootermenu list-unstyled">
											<li>- <a href="https://www.allen.ac.in/imagegallery/gs/embed.aspx?u=bhubaneswar" target="_blank">Photo Gallery</a></li>
						...
						<div class="col-lg-2 col-md-6">
							<div class="f_widget about-widget">
								<h3 class="f-title f_600 t_color2 f_size_16 mb_15">Programmes</h3>
								<ul class="list-unstyled f_list">
									<li><a href="https://www.onlinetestseries.in/allenbhubaneswar">Online Test Series</a></li>
						...
						<div class="col-lg-2 col-md-6">
							<div class="f_widget about-widget">
								<h3 class="f-title f_600 t_color2 f_size_16 mb_15">Websites</h3>
								<ul class="list-unstyled f_list">
									<li><a href="https://www.klipinterest.com/">Klipinterest</a></li>
									<li><a href="https://www.allengsp.com/">Gyan Se Pehchan</a></li>
									<li><a href="https://www.kliponar.com/">Kliponar</a></li>
									<li><a href="https://ntsehelpline.com/">NTSE Helpline</a></li>
									<li><a href="https://www.allenchamp.com/">ALLEN Champ</a></li>
									<li><a href="https://www.tallentex.com/">TALLENTEX</a></li>
									<li><a href="https://myexam.allen.ac.in/">ALLEN Blog</a></li>
									<li><a href="https://www.allenites.com/">ALLEN Alumni Network</a></li>
								</ul>
							</div>
						</div>
					</div>
		...
		<div class="container mobile-footer">
			<div class="row d-block">
				<div class="tab-content faq_content Cus_acc col-lg-12" id="myTabContent">
						...
						<div id="accordion">
								...
								<div class="card-header" id="headingOne">
									<h5 class="mb-0">
										<button class="btn btn-link" data-toggle="collapse" data-target="#collapseOne"
											aria-expanded="true" aria-controls="collapseOne"> Contact <i
							...
							<div class="card">
								...
								<div id="collapseSeven" class="collapse" aria-labelledby="headingSeven"
									...
									<div class="card-body">
										<ul class="list-unstyled f_list">
											<li><a href="/bhubaneswar/jee-main-coaching.asp">JEE (Main) </a></li>
											<li><a href="/bhubaneswar/iit-jee-main-advanced-coaching.asp">JEE (Advanced)</a>
											</li>
											<li><a href="/bhubaneswar/neet-ug-aiims-coaching.asp">NEET-UG</a></li>
											<li><a href="/pncf/bhubaneswar/">PNCF (Class 6<sup>th</sup> to 10<sup>th</sup>)</a>
											</li>
											<li><a href="https://www.theintellibrain.com/">Intellibrain ( HKG to
													5<sup>th</sup>)</a></li>
										</ul>
								...
								<div class="card-header" id="headingTwo">
									<h5 class="mb-0">
										<button class="btn btn-link collapsed" data-toggle="collapse"
											...
											aria-controls="collapseTwo"> Quick Links<i class="fa fa-angle-down"></i><i
								...
								<div id="collapseTwo" class="collapse" aria-labelledby="headingTwo"
									...
									<div class="card-body">
										<ul class="list-unstyled f_list">
											...
											<li><a href="">Gallery</a>
											<ul class="subfootermenu list-unstyled">
											<li> <a href="https://www.allen.ac.in/imagegallery/gs/embed.aspx?u=bhubaneswar">- Photo Gallery</a></li>
							...
							<div class="card">
								<div class="card-header" id="headingThree">
									<h5 class="mb-0">
										<button class="btn btn-link collapsed" data-toggle="collapse"
											...
											aria-controls="collapseThree">Programmes<i class="fa fa-angle-down"></i><i
												class="fa fa-angle-up"></i>
										</button>
									</h5>
								</div>
								<div id="collapseThree" class="collapse" aria-labelledby="headingThree"
									...
									<div class="card-body">
										<ul class="list-unstyled f_list">
											<li><a href="https://www.onlinetestseries.in/allenbhubaneswar">Online Test
													Series</a></li>
											<li><a href="https://dlp.allen.ac.in/">DLP</a></li>
											<li><a href="https://www.allen.ac.in/globalstudies/">AGSD</a></li>
											<li><a href="https://tab.allen.ac.in/"> TAB Elearning Tool</a></li>
								...
								<div class="card-header" id="headingFourth">
									<h5 class="mb-0">
										<button class="btn btn-link collapsed" data-toggle="collapse"
											...
											aria-controls="collapseFourth">Results<i class="fa fa-angle-down"></i><i
												class="fa fa-angle-up"></i>
										</button>
									</h5>
								</div>
								...
								<div class="card-header" id="headingSix">
									<h5 class="mb-0">
										<button class="btn btn-link collapsed" data-toggle="collapse"
											...
											aria-controls="collapseSix">Websites<i class="fa fa-angle-down"></i><i
												class="fa fa-angle-up"></i>
										</button>
									</h5>
								</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					...
					My Prep OLTS</a></li>
					<li><a href="https://play.google.com/store/apps/details id=prepg.series.test.online.com.prepgonlinetestseries&hl=en_IN">Test My Prep Pre-PG</a></li>
			...
			<div class="row">
				<div class="col-lg-4 col-md-4">
					<p class="mb-0 f_400 mt-1">
						<a href="https://www.allenites.com/" target="_blank" title="ALLEN Alumni Network"><img
								src="/assets/img/allenites-logo.png" class="img-fluid opacity05" alt=""></a>
					</p>
				</div>
				<div class="col-lg-8 col-md-8">
					<ul class="list-unstyled f_menu text-right mb-1">
						...
						<li><a href="/payment-terms.asp">Payment Terms</a></li>
...
<script src="/assets/js/metatags/metatags-bhubaneswar.js"></script>
