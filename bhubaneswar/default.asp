   ...
   <div class="container">
      <div class="row brd-count wow fadeInLeft">
         <div class="col-md-6 col-lg-3 col-sm-12 brd-vertical">
            <div class="counter">
               <i class="icon-counter"><img src="/assets/img/counterico/1.png" class="img-fluid" alt=""></i>
         ...
         <div class="col-md-6 col-lg-3 col-sm-12 brd-vertical">
            <div class="counter">
               <i class="icon-counter"><img src="/assets/img/counterico/4.png" class="img-fluid" alt=""></i>
               <div class="wrpconttxt">
         ...
         <div class="col-md-6 col-lg-3 col-sm-12 brd-vertical">
            <div class="counter">
               <i class="icon-counter"><img src="/assets/img/counterico/5.png" class="img-fluid p-2" alt=""></i>
               <div class="wrpconttxt">
         ...
         <div class="col-md-6 col-lg-3 col-sm-12">
            <div class="counter">
               <i class="icon-counter"><img src="/assets/img/counterico/3.png" class="img-fluid" alt=""></i>
               <div class="wrpconttxt">
      ...
      <div class="row  wow fadeInRight">
         <div class="col-md-6 col-lg-3 col-sm-12">
            <div class="counter">
               <i class="icon-counter"><img src="/assets/img/counterico/10.png" class="img-fluid" alt=""></i>
               <div class="wrpconttxt">
         ...
         <div class="col-md-6 col-lg-3 col-sm-12">
            <div class="counter">
               <i class="icon-counter"><img src="/assets/img/counterico/7.png" class="img-fluid" alt=""></i>
               <div class="wrpconttxt">
         ...
         <div class="col-md-6 col-lg-3 col-sm-12">
            <div class="counter">
               <i class="icon-counter"><img src="/assets/img/counterico/8.png" class="img-fluid" alt=""></i>
               <div class="wrpconttxt">
                  <p class="count-title"><span class="counter-count">140</span>+</p>
                  <p class="count-text ">Total<br>Test Centers</p>
               </div>
            </div>
         </div>
         ...
         <div class="col-md-6 col-lg-3 col-sm-12">
            <div class="counter">
               <i class="icon-counter"><img src="/assets/img/counterico/9.png" class="img-fluid" alt=""></i>
               <div class="wrpconttxt">
                  <p class="count-title"><span class="counter-count">1831</span>+</p>
                  <p class="count-text ">Total<br>Classroom</p>
               </div>
            </div>
         </div>
...
<!--#include virtual="/common/newsletter/subscribe_newsletter_bhubaneswar.asp"-->
...
<script type="text/javascript">
   ...
   $(document).ready(function () {
      var centerUpdate = bhubaneswar_updates;
      centerUpdates(centerUpdate, $);

      var importantUpdate = bhubaneswar_importantNotification;
      importantNotifications(importantUpdate, $);

      var resultUpdate = bhubaneswar_resultNotification;
