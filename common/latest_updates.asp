            ...
            <div class="col-md-12 d-flex align-items-center">
                <div class="developer_product_content d_product_content_two text-center">
                    ...
                    <ul class="nav nav-tabs develor_tab mb-30" id="myTab2" role="tablist">
                        <!-- <li class="nav-item">
                            <a class="nav-link active show text-capitalize" id="ruby-tab" data-toggle="tab" href="#ruby" role="tab"
                                aria-controls="ruby" aria-selected="false"><i class="latico"><img src="/assets/img/notification/info.png" class="img-fluid" alt=""></i> Updates </a>
                        </li> -->
                        <li class="nav-item">
                            <a class="nav-link active show" id="curl-tab" data-toggle="tab" href="#curl" role="tab"
                                aria-controls="curl" aria-selected="false"><i class="latico"><img src="/assets/img/notification/result-notification.png" class="img-fluid"  alt=""></i> Important
                                Notification</a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link" id="resize-tab" data-toggle="tab" href="#resize" role="tab"
                                aria-controls="resize" aria-selected="false"><i class="latico"><img src="/assets/img/notification/events.png" class="img-fluid"  alt=""></i> Result Notification</a>
                        </li>
                    </ul>
                    ...
                    <div class="tab-content developer_tab_content text-left">
                        ...
                        <div class="tab-pane fade active show" id="curl" role="tabpanel" aria-labelledby="curl-tab">
                            <div class="container">
                                <div class="row">
