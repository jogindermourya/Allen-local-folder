           ...
           <!-- Top Menu Section -->
                            ...
                            <div class="navbar-nav navbar-nav-hover align-items-lg-center topmenu row">
                                ...
                                <div class="col-lg-4 col-sm-12 fullwd320">
                                    <ul class="header_contact_info list-unstyled text-right">
                                        ...
                                        <li>
                                            <a href="/surat/contactus.asp"> <i class="fa fa-building"></i> Contact</a>
                                        </li>
                                        <li>
            ...
            <nav class="navbar navbar-expand-lg menu_one header-decor">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="/surat"><img src="/assets/img/site_logo/surat.jpg" class="img-fluid" alt="logo"></a>
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarSupportedContent">
                        <ul class="navbar-nav menu w_menu ml-auto mr-auto">
                                ...
                                <div class="mega_menu_inner coursemenu">
                                    <ul class="dropdown-menu">
                                        <li class="nav-item">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li class="nav-item"><a class="nav-link" href="/surat/iit-jee-main-Advanced-coaching.asp">JEE (Main+Advanced)</a></li>
                                                 <li class="nav-item"><a class="nav-link" href="/surat/jee-main-coaching.asp">JEE (Main)</a></li> 
                                                <li class="nav-item"><a class="nav-link" href="/surat/neet-ug-aiims-coaching.asp">Pre-Medical</a></li>
                                                <li class="nav-item"><a class="nav-link" href="/pncf/surat/" target="_blank">Pre-nurture & Career Foundation</a></li>
                                        ...
                                        <li class="nav-item">
                                            ...
                                            <ul class="dropdown-menu">
                                                ...
                                                <li class="nav-item"><a class="nav-link" target="_blank" href="https://www.onlinetestseries.in/allensurat/">Online Test Series</a> </li>
                            ...
                            <li class="dropdown submenu nav-item">
                                ...
                                <ul role="menu" class=" dropdown-menu">
                                    <li class="nav-item"><a class="nav-link" href="/surat/2020-21/how-to-apply.asp">How to Apply for APPLICATION FORM</a></li>
                                    <li class="nav-item"><a class="nav-link" href="https://www.allen.ac.in/appsmvc2021/appforms/Login"  target="_blank" >Apply Online</a></li>
                                    <li class="nav-item"><a class="nav-link" href="/surat/2020-21/fee-deposition-modes.asp">Fee Deposition Modes</a></li>
                                    <li class="nav-item"><a class="nav-link"  href="/surat/2020-21/scholarship-rules.asp">Scholarship Rules</a></li>
                                    <li class="nav-item"><a class="nav-link" href="/surat/2020-21/refund-rules.asp"> Refund Rules</a></li>
                                    <li class="nav-item"><a class="nav-link" href="/surat/2020-21/allen-kohinoor-hostel.asp">Kohinoor Hostel Scheme (ACES)</a></li>
                                </ul>
                            </li>
                            <li class="dropdown submenu nav-item">
                                <a class="dropdown-toggle nav-link" data-toggle="dropdown" role="button"
                                ...
                                <ul role="menu" class=" dropdown-menu">
                                    <li class="nav-item"><a class="nav-link" href="/surat/2020-21/about-allen-scholarship-admission-test.asp">ALLEN Scholarship Admission Test (ASAT)</a></li>                                    <li class="nav-item"><a class="nav-link" href="https://www.allen.ac.in/ASATRESULTNEW/Results.aspx">ASAT Result</a></li>
