...
<section class="coursebg"> 
      ...
      <div class="row">
        <div class="col-lg-10 col-sm-9 ">
          <ul class="list-unstyled breadcrumb-links m-0">
            ...
            <li><a href="/bhilwara/iit-jee-main-Advanced-coaching.asp">IIT JEE Main Advanced Coaching</a></li>
            <li>IIT-JEE (MAIN + ADVANCED)</li>
          </ul>
        </div>
        <div class="col-lg-2 col-sm-3 "> <a href="/bhilwara/iit-jee-main-advanced-coaching.asp" class=" blue_btn btn_hover d-inline-block"><i class="fa fa-angle-left f_size_20 mr-1"></i> Back</a> </div>
      </div>
    </div>
  </section>
  <style>
  ...
  <section class="cours_content_wrp" ng-app="myApp" ng-controller="bhil" ng-cloak >
      ...
      <div class="row mb-3 ">
        <div class="col-lg-12 col-md-12 col-sm-12">
          <div class="cover_box" id="course_details">
            ...
            <h4 class="color-green "><strong>NURTURE : <span class="color-darker">Two Year Course for Class XI Students (English Medium Students)</span></strong></h4>
    ...
    -->
                ...
                <tbody ng-repeat="data in iitnur" >
                    <tr>
    ...
    <!--                    <td rowspan="{{data.Courses.length}}"><span>{{ data.centdetail }}</span></td>-->
            ...
            <h4 class="color-green"><strong>ENTHUSIAST : <span class="color-darker">  One Year Course for Class XII Students (English Medium Students)</span></strong></h4>
            <div class="table-responsive">            
                   <table class="table table-bordered dt-responsive table-hover customtbl cetnble " width="100%">
                      <thead>
                          <tr>
                      ...
                      <tbody ng-repeat="data in iitenth" >
                          <tr>
                              <td align="center"><span>{{data.Courses[0].phase}}</span></td>
                              <td align="center"><span>{{data.Courses[0].commdate | date : 'dd/MM/yyyy' }}</span></td>
                              <td align="center"><span>{{data.Courses[0].ccode}}</span></td>
				...
				<h4 class="color-green"><strong>LEADER  : <span class="color-darker"> One Year Course for Class XII Passed / Appeared Students (English Medium Students)</span></strong></h4>
              <div class="table-responsive">
                <table class="table table-bordered dt-responsive table-hover customtbl cetnble " width="100%">
            <thead>
                <tr>
            ...
            <tbody ng-repeat="data in iitlead" >
                <tr>
                    <td align="center"><span>{{data.Courses[0].phase}}</span></td>
                    <td align="center"><span>{{data.Courses[0].commdate | date : 'dd/MM/yyyy' }}</span></td>
                    <td align="center"><span>{{data.Courses[0].ccode}}</span></td>
...
<%End If%>
                        ...
                        <ol>
                            ...
                            <li>Total Deductable Amount in Refund* Cases : 1st Refund : <i class="fa fa-inr"></i> 20000/- & Last Refund : <i class="fa fa-inr"></i> 40000/- ( <a href="/bhilwara/2020-21/refund-rules.asp" class="color-blue">Click here for Refund Rules</a> )</li>
