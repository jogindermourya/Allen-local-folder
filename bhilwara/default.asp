...
<!--#include virtual="/common/newsletter/subscribe_newsletter_bhilwara.asp"-->
...
<script type="text/javascript">
   ...
   $(document).ready(function () {
      var centerUpdate = bhilwara_updates;
      centerUpdates(centerUpdate, $);

      var importantUpdate = bhilwara_importantNotification;
      importantNotifications(importantUpdate, $);

      var resultUpdate = bhilwara_resultNotification;
