      ...
      <div class="row">
        <div class="col-lg-10 col-sm-9 ">
          <ul class="list-unstyled breadcrumb-links m-0">
            ...
            <li><a href="/bengaluru/iit-jee-main-Advanced-coaching.asp">IIT JEE Main Advanced Coaching</a></li>
            <li>IIT-JEE (MAIN + ADVANCED)</li>
          </ul>
        </div>
        <div class="col-lg-2 col-sm-3 "> <a href="/bengaluru/iit-jee-main-advanced-coaching.asp" class=" blue_btn btn_hover d-inline-block"><i class="fa fa-angle-left f_size_20 mr-1"></i> Back</a> </div>
      </div>
    </div>
  </section>
  <style>
...
<%End If%>
                        ...
                        <ol>
                            ...
                            <li>Total Deductable Amount in Refund* Cases : 1st Refund : <i class="fa fa-inr"></i> 25000/- & Last Refund : <i class="fa fa-inr"></i> 50000/- ( <a href="/bengaluru/2020-21/refund-rules.asp" class="color-blue">Click here for Refund Rules</a> )</li>
