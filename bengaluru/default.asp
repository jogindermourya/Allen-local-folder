...
<!--#include virtual="/common/newsletter/subscribe_newsletter_bengaluru.asp"-->
...
<script type="text/javascript">
   ...
   $(document).ready(function () {
      var centerUpdate = bengaluru_updates;
      centerUpdates(centerUpdate, $);

      var importantUpdate = bengaluru_importantNotification;
      importantNotifications(importantUpdate, $);

      var resultUpdate = bengaluru_resultNotification;
