...
<!--#include virtual="/common/newsletter/subscribe_newsletter_guwahati.asp"-->
...
<script type="text/javascript">
   ...
   $(document).ready(function () {
      var centerUpdate = guwahati_updates;
      centerUpdates(centerUpdate, $);

      var importantUpdate = guwahati_importantNotification;
      importantNotifications(importantUpdate, $);

      var resultUpdate = guwahati_resultNotification;
