      ...
      <div class="row">
        <div class="col-lg-10 col-sm-9 ">
          <ul class="list-unstyled breadcrumb-links m-0">
            ...
            <li><a href="/guwahati/jee-main-coaching.asp">IIT JEE Main Coaching</a></li>
            <li>IIT JEE MAIN</li>
          </ul>
        </div>
        <div class="col-lg-2 col-sm-3 "> <a href="/guwahati/jee-main-coaching.asp" class=" blue_btn btn_hover d-inline-block"><i class="fa fa-angle-left f_size_20 mr-1"></i> Back</a> </div>
      </div>
    </div>
  </section>
  <style>
                    ...
                    <td align="right"><span>{{item.iiamt1 | currency:'&#8377;&nbsp;'}}</span></td>
                      ...
                      <%End If%>
                        ...
                        <ol>
                            ...
                            <li>Total Deductable Amount in Refund Cases : First Refund : <i class="fa fa-inr"></i> 15000/- & Last Refund : <i class="fa fa-inr"></i> 30000/- ( <a href="/guwahati/2020-21/refund-rules.asp" class="color-blue">Click here for Refund Rules</a> )</li>
