			 ...
			 <div class="row mb-3 mt-0">
				...
				<div class="col-lg-11">
				   ...
				   <p><span class="color-red">In case of ASAT</span>, this option is available after confirm
					  selection in ASAT / <span><strong>in case of Direct Admission</strong></span> this option
					  is available after
				   ...
				   <p>For details <a href="https://www.allen.ac.in/appsmvc2021/FormStatus/Login">
					  Click Here </a> OR For getting details send sms <span><strong>RTGS to
					  9829988255</strong></span>
				   </p>
				</div>
			 </div>
			 <div class="row mb-3 mt-3">
			 ...
			 <div class="row mb-3 mt-3">
				<div class="col-lg-11">
				   <p><b>In Case of ASAT :</b></p>
					<p>Fee can be deposited only after qualifying the Test for courses where ASAT (ALLEN Scholarship Admission Test) is applicable.Student may deposit their fee through any one of the above modes.</p>
				</div>
			 </div>
		  </div>
	   </div>
