...
<!--#include virtual="/common/newsletter/subscribe_newsletter_ahemdabad.asp"-->
...
<script type="text/javascript">
   ...
   $(document).ready(function () {
      var centerUpdate = ahmedabad_updates;
      centerUpdates(centerUpdate, $);

      var importantUpdate = ahmedabad_importantNotification;
      importantNotifications(importantUpdate, $);

      var resultUpdate = ahmedabad_resultNotification;
