  ...
  <section class="bricurm">
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-2 col-sm-3 "> <a href="/ahmedabad/iit-jee-main-advanced-coaching.asp" class=" blue_btn btn_hover d-inline-block"><i class="fa fa-angle-left f_size_20 mr-1"></i> Back</a> </div>
      </div>
    </div>
  </section>
  <style>
          ...
          <div class="cover_box" id="course_details">
            ...
            <tbody ng-repeat="data in iitlead" >
                ...
                <tr align="center" ng-repeat="item in data.Courses| orderBy:'commdate'" ng-if="$index > 0" ng-class="{active: datehighlight(item.commdate)}">
              	...
              	<h4 class="color-green"><strong>AMBITION   : <span class="color-darker"> For Class IX English Medium Students</span></strong></h4>
              <div class="table-responsive">
                <table class="table table-bordered dt-responsive table-hover customtbl cetnble " width="100%">
            <thead>
                <tr>
            ...
            <tbody ng-repeat="data in iitamb" >
                <tr>
                    <td align="center"><span>{{data.Courses[0].phase}}</span></td>
                    <td align="center"><span>{{data.Courses[0].commdate | date : 'dd/MM/yyyy' }}</span></td>
                    <td align="center"><span>{{data.Courses[0].ccode}}</span></td>
                ...
                <tr align="center" ng-repeat="item in data.Courses| orderBy:'commdate'" ng-if="$index > 0" ng-class="{active: datehighlight(item.commdate)}">
               	...
               	<h4 class="color-green"><strong>ASPIRE   : <span class="color-darker"> For Class X English Medium Students</span></strong></h4>
              <div class="table-responsive">
                <table class="table table-bordered dt-responsive table-hover customtbl cetnble " width="100%">
            <thead>
                <tr>
            ...
            <tbody ng-repeat="data in iitasp" >
                <tr>
                    <td align="center"><span>{{data.Courses[0].phase}}</span></td>
                    <td align="center"><span>{{data.Courses[0].commdate | date : 'dd/MM/yyyy' }}</span></td>
                    <td align="center"><span>{{data.Courses[0].ccode}}</span></td>
