...
<head>
	...
	<link rel="canonical" href="https://www.allen.ac.in" />
    ...
    <link rel="stylesheet" href="/assets/css/responsive.css">
      ...
      <!--Center CSS-->
      <link rel="stylesheet" href="/ahmedabad/assets/css/center_css.css">
    ...
    <!-- Header Section -->
		...
		-->
           <!-- Top Menu Section -->
            <div class="header_top allen-header">
                <div class="container">
                    <nav class="navbar navbar-expand-lg navbar-dark bg_tophd no-pd">
                        <span class="topmenubar">Top Menu</span>
                        <button class="navbar-toggler collapsed" type="button" data-toggle="collapse"
                            data-target="#navbar-default" aria-controls="navbar-default" aria-expanded="false" aria-label="Toggle navigation"> <i class="fa fa-angle-down tpicon"></i>
                        </button>
                        <div class="navbar-collapse collapse custm-menu" id="navbar-default">
                            <div class="navbar-nav navbar-nav-hover align-items-lg-center topmenu row">
                                ...
                                <div class="col-lg-4 col-sm-12 fullwd320">
                                    <ul class="header_contact_info list-unstyled text-right">
                                        ...
                                        <li>
                                            <a href="/ahmedabad/contactus.asp"> <i class="fa fa-building"></i> Contact</a>
                                        </li>
                                        <li>
            ...
            <!-- Main Menu Section -->
            <nav class="navbar navbar-expand-lg menu_one header-decor">
                <div class="container">
                    <button class="navbar-toggler collapsed" type="button" data-toggle="collapse"
                    ...
                    <a class="navbar-brand" href="/ahmedabad/"><img src="/assets/img/site_logo/ahmedabad_logo.jpg" class="img-fluid" alt="logo"></a>
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarSupportedContent">
                        <ul class="navbar-nav menu w_menu ml-auto mr-auto">
                                ...
                                <div class="mega_menu_inner coursemenu">
                                    <ul class="dropdown-menu">
                                        <li class="nav-item">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li class="nav-item"><a class="nav-link" href="/ahmedabad/jee-main-coaching.asp">JEE (Main)</a></li>
                                                <li class="nav-item"><a class="nav-link" href="/ahmedabad/iit-jee-main-Advanced-coaching.asp">JEE (Main+Advanced)</a></li>
                                                <li class="nav-item"><a class="nav-link" href="/ahmedabad/neet-ug-aiims-coaching.asp">Pre-Medical</a></li>
                                                <li class="nav-item"><a class="nav-link" href="/pncf/ahmedabad/" target="_blank">Pre-nurture & Career Foundation</a></li>
                                        ...
                                        <li class="nav-item">
                                            ...
                                            <ul class="dropdown-menu">
                                                ...
                                                <li class="nav-item"><a class="nav-link" target="_blank" href="https://www.onlinetestseries.in/allenahmedabad/">Online Test Series</a> </li>
                            ...
                            <li class="dropdown submenu nav-item">
                                ...
                                <ul role="menu" class=" dropdown-menu">
                                    <li class="nav-item"><a class="nav-link" href="/ahmedabad/2020-21/how-to-apply.asp">How to Apply for APPLICATION FORM</a></li>
                                    <li class="nav-item"><a class="nav-link" href="https://www.allen.ac.in/appsmvc2021/appforms/Login">Apply Online</a></li>
<!--                                    <li class="nav-item"><a class="nav-link" href="/ahmedabad/2020-21/about-allen-scholarship-admission-test.asp">ALLEN Scholarship Admission Test (ASAT)</a></li>-->
                                    <li class="nav-item"><a class="nav-link" href="/ahmedabad/2020-21/fee-deposition-modes.asp">Fee Deposition Modes</a></li>
                                    <li class="nav-item"><a class="nav-link"  href="/ahmedabad/2020-21/scholarship-rules.asp">Scholarship Rules</a></li>
                                    <li class="nav-item"><a class="nav-link" href="/ahmedabad/2020-21/refund-rules.asp"> Refund Rules</a></li>
                                    <li class="nav-item"><a class="nav-link" href="/ahmedabad/2020-21/allen-kohinoor-hostel.asp">Kohinoor Hostel Scheme (ACES)</a></li>
                                </ul>
                            </li>
                            <li class="dropdown submenu nav-item">
                                <a class="dropdown-toggle nav-link" data-toggle="dropdown" role="button"
                                ...
                                <ul role="menu" class=" dropdown-menu">
                                    <li class="nav-item"><a class="nav-link" href="/ahmedabad/2020-21/about-allen-scholarship-admission-test.asp">ALLEN Scholarship Admission Test (ASAT)</a></li>                                    <li class="nav-item"><a class="nav-link" href="https://www.allen.ac.in/ASATRESULTNEW/Results.aspx">ASAT Result</a></li>
                            ...
                            <li class="nav-item dropdown submenu mega_menu">
                                ...
                                <div class="mega_menu_inner container">
                                    <ul class="dropdown-menu">
                                        <li class="nav-item">
                    ...
                    <div class="alter_nav">
                        <a class="onlineenqury_btn btn_hover" href="#" data-toggle="modal"  
                            data-target="#exampleModalCenter"> Apply Online</a>
                    </div>
                </div>
            </nav>
